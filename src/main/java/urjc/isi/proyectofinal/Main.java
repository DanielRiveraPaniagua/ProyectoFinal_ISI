...
public class Main {
	...
	public static String defaultResponse(Request request, Response response) throws ClassNotFoundException, URISyntaxException {
		return "<span style=bgcolor:#FF7247;</span><form action='/pag_principal' method='post' enctype='multipart/form-data'>"
			...
			+ "-->" + "<a href=https://prueba-grupo4.herokuapp.com/directores/selectAll?id_dir=x>id</a>" + "<br>"
			+ "-->" + "<a href=https://prueba-grupo4.herokuapp.com/directores/selectAll?name=x>nombre</a>" + "<br>"
			+ "-->" + "<a href=https://prueba-grupo4.herokuapp.com/directores/selectAll?fecha_nac=x>fecha de nacimiento</a>" + "<br>"
			+ "-->" + "<a href=https://prueba-grupo4.herokuapp.com/directores/selectAll?fecha_nac=x-x>intervalo fecha de nacimiento</a>" + "<br>"
			+ "-->" + "<a href=https://prueba-grupo4.herokuapp.com/directores/selectAll?fecha_muer=x>fecha de muerte</a>" + "<br>"
			+ "-->" + "<a href=https://prueba-grupo4.herokuapp.com/directores/selectAll?fecha_muer=x-x>intervalo fecha de muerte</a>" + "<br>"
			+ "<p>Sustituyendo las x por los valores deseados</p>"
			...
			+ "-->" + "<a href=https://prueba-grupo4.herokuapp.com/guionistas/selectAll?fecha_muer=x>fecha de muerte</a>" + "<br>"
			+ "-->" + "<a href=https://prueba-grupo4.herokuapp.com/guionistas/selectAll?fecha_muer=x-x>intervalo fecha de muerte</a>" + "<br>"
			+ "<p>Sustituyendo las x por los valores deseados</p>"
